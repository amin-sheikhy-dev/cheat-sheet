```js
// Promises , Fetch API_______________________________________________________________________________
...
// Chaining , Rejected Promises , Throwing Errors_______________________________________________________________________________________
...
// Event Loop => CallBack Queue , MicroTasks___________________________________________________________________________________________
...
// Building a Promise______________________________________________________________________________
...
// Async Await => Consuming Promise , Error Handling_______________________________________________________________________________________
...
// Promise Type => all , race , Allsettled , Any___________________________________________________________________________________________
...
```js
// fetch function argument_________________________________________________________________________________
// هست و ورودی دوم ابجکت ویژگی ها URL این تابع 2 تا ورودی میگیره که ورودی اول

// با تمام ورودی ها
fetch(URL, { method, body, headers, signal, credentials, mode, cache });
...
// مجاز نیست GET برای
body: JSON.stringify({ product: 'book', price: 100 });
body: JSON.stringify({ email: 'exmaple@gmail.com', password: '1234' });
...
```js
// GET_______________________________________________________________________________________
// (پیش‌فرض) گرفتن دیتا
...
// POST_______________________________________________________________________________________
// ساختن دیتا
...
// PUT_______________________________________________________________________________________
// جایگزینی کامل
...
// PATCH_______________________________________________________________________________________
// ویرایش جزئی
async function updateData(id, userData) {
  const res = await fetch(`http://URL/data/${id}`, {
    method: 'PATCH',
